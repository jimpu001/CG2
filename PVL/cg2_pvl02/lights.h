...
struct uboLightData
{
	...
	void setDirection(const glm::vec3& dir){position= glm::vec4(dir,0.0f);}
	void setColor(const glm::vec3& color){color_ambientFactor = glm::vec4(color,color_ambientFactor.a);}
	void setSpotDirection(const glm::vec3& dir){spotDir_cosCutOff = glm::vec4(dir,spotDir_cosCutOff.w);}
	void setCosSpotCutoff(const float& cos_co){spotDir_cosCutOff.a = cos_co;}
